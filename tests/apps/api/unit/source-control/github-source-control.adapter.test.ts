...
test('BT-032: GithubSourceControlAdapter creates an open GitHub pull request', async () => {
  let capturedUrl = '';
  ...
  const result = await adapter.createReviewRequest({
...
test('GithubSourceControlAdapter creates GitHub App installation token before PR creation', async () => {
