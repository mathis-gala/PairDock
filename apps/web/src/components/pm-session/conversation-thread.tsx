...
export function ConversationThread({ isTyping, items }: ConversationThreadProps) {
        ...
        >
          <div
            className={classNames(
              'min-w-0 max-w-[86%] whitespace-pre-wrap [overflow-wrap:anywhere] rounded-2xl text-[13.5px] leading-5',
              item.role === 'user'
