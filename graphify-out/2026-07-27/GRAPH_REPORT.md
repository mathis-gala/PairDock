...
Cohesion: 0.06
Nodes (22): HealthcheckWaitInput, HealthcheckResult, SandboxPort, SandboxRef, SandboxStartInput, allocateHostPort(), execFileAsync, HostPreviewRuntimeAdapter (+14 more)
...
Cohesion: 0.11
Nodes (21): ProjectPreviewConfig, SessionCloseResult, SessionPrepareHooks, SessionRecoveryResult, SessionRunnerConfig, assertSafeContainerImage(), buildCloudflareDockerArgs(), buildTunnelContainerName() (+13 more)
...
Cohesion: 0.06
Nodes (28): AgentCommandRouterService, Inject, Injectable, isCommandAcknowledgement(), mapSession(), SessionsRepositoryAdapter, Inject, Injectable (+20 more)
...
Cohesion: 0.06
Nodes (20): ApiClient, authHeaders(), AuthProviders, authProvidersSchema, CreateSessionInput, jsonHeaders(), requestJson(), RequestOptions (+12 more)
...
Cohesion: 0.07
Nodes (26): AGENT_AUTHENTICATION_OPTIONS, AgentAuthenticationOptions, AgentCredentialInput, AuthenticatedAgentPrincipal, extractBearerToken(), isRecord(), parseCredentials(), Inject (+18 more)
...
Cohesion: 0.09
Nodes (12): Inject, Inject, cloneSnapshot(), ConnectedAgentsRegistry, Injectable, authenticateDeveloper(), authenticatePm(), prisma (+4 more)
...
Cohesion: 0.09
Nodes (18): CreateSessionAttachmentsInput, SessionAttachmentsService, Inject, Injectable, AttachmentsRepositoryAdapter, Inject, Injectable, mapAttachment() (+10 more)
...
### Community 43 - "ui.ts"
Cohesion: 0.24
Nodes (4): errorMessage(), SessionRunner, GitPushBranchCommandEnvelope, SessionCloseCommandEnvelope
...
Cohesion: 0.11
Nodes (20): isToolReadinessKey(), isToolReadinessStatus(), parseToolReadinessCheck(), parseToolReadinessChecks(), serializeChecks(), serializeJsonValue(), serializeToolReadinessCheck(), toInputJsonObject() (+12 more)
...
Cohesion: 0.16
Nodes (10): detectImageType(), isJpeg(), isPng(), isWebp(), safeOriginalName(), ValidatedScreenshot, validateScreenshot(), validateScreenshots() (+2 more)
...
Cohesion: 0.12
Nodes (12): AttachmentsController, Controller, Inject, mapProject(), ProjectsRepositoryAdapter, Inject, Injectable, CreateProjectInput (+4 more)

### Community 76 - "pm-activity-page.tsx"
Cohesion: 0.06
Nodes (35): Button(), ButtonProps, ButtonVariant, variantClasses, ConnectionActivityRail(), ConnectionActivityRailProps, RailMetricProps, DeveloperProjectCard() (+27 more)

### Community 77 - "commands.ts"
Cohesion: 0.15
Nodes (9): isLifecycleProgressStatus(), toSessionAgentEvent(), ConnectedSocket, MessageBody, SubscribeMessage, BackendEventRejectedError, AgentEventEnvelope, ChecksResultEventEnvelope (+1 more)
...
### Community 87 - ".create"
Cohesion: 0.22
Nodes (10): DeveloperProjectCardProps, buildProjectMetadataUpdate(), ProjectMetadataForm(), ProjectMetadataFormProps, ProjectMetadataValues, ShareDeveloperProjectInput, UpdateExecutionDefaultsInput, UpdateProjectInput (+2 more)
...
Cohesion: 0.13
Nodes (13): mapValidationRun(), Inject, Injectable, ValidationRunsRepositoryAdapter, CreateValidationRunInput, ValidationRunsRepository, Injectable, ValidationPolicy (+5 more)

### Community 90 - "agent-gateway.integration.test.ts"
Cohesion: 0.08
Nodes (23): createDeveloperProjectInputSchema, developerProjectReadinessSchema, developerProjectSessionSummarySchema, developerProjectSetupSchema, developerProjectSummaryListSchema, developerProjectSummarySchema, DeveloperSetupAgent, developerSetupAgentModelSchema (+15 more)
...
Cohesion: 0.10
Nodes (33): AgentExecutionCapabilitiesService, SessionExecutionSelection, Injectable, AgentProjectBindingService, Injectable, AGENT_EVENTS_REPOSITORY, AGENT_REGISTRATIONS_REPOSITORY, ATTACHMENTS_REPOSITORY (+25 more)
...
Cohesion: 0.17
Nodes (5): authenticateDeveloper(), authenticatePm(), createSession(), prisma, sessionPromptResponseSchema
...
Cohesion: 0.12
Nodes (11): AppModule, Module, bootstrap(), startApplication(), startApplication(), sessionIdResponseSchema, authenticateDeveloper(), authenticatePm() (+3 more)
...
Cohesion: 0.11
Nodes (17): UploadedScreenshot, mapSourceControlConnection(), SourceControlConnectionsRepositoryAdapter, Inject, Injectable, CreateSourceControlConnectionInput, SourceControlConnectionsRepository, appendScreenshotsToReviewDescription() (+9 more)
...
Cohesion: 0.11
Nodes (18): AgentAuthenticationService, Injectable, AgentGateway, Inject, Injectable, WebSocketGateway, WebSocketServer, ConnectedAgentSnapshot (+10 more)
...
Cohesion: 0.14
Nodes (10): Inject, mapSessionMember(), SessionMembersRepositoryAdapter, Inject, Injectable, AddSessionMemberInput, SessionMembersRepository, CreatePromptRequest (+2 more)
...
Cohesion: 0.07
Nodes (33): AgentEventsRepositoryAdapter, Inject, Injectable, parseJsonObject(), isExternalIdentityProvider(), isProjectMembershipRole(), mapAgentEvent(), mapProjectMembership() (+25 more)
...
Cohesion: 0.22
Nodes (4): authenticateDeveloper(), authenticatePm(), prisma, startApplication()

### Community 170 - "ChecksResult"
Cohesion: 0.32
...
- **Why does `resolve()` connect `github-developer-identity.adapter.ts` to `json-parsers.ts`, `persistence.integration.test.ts`, `support.js`, `AgentCommandEnvelope`, `example-project.integration.test.ts`, `scripts`, `walk`, `createRuntime`?**
