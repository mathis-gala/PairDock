...
## Corpus Check
- 333 files · ~147,516 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3009 nodes · 6663 edges · 172 communities (147 shown, 25 thin omitted)
...
Cohesion: 0.06
Nodes (23): buildHostCommandEnvironment(), HealthcheckWaitInput, HealthcheckResult, SandboxPort, SandboxRef, SandboxStartInput, allocateHostPort(), execFileAsync (+15 more)
...
Cohesion: 0.06
Nodes (36): agentCommandEnvelopeSchema, checkResultSchema, envelopeBaseSchema, isoDateTimeSchema, promptableSessionStatuses, sessionEnvelope(), SessionStatus, sessionStatusSchema (+28 more)
...
Cohesion: 0.07
Nodes (29): AgentCommandRouterService, Inject, Injectable, AttachmentsController, Controller, Inject, SessionAttachmentsService, Injectable (+21 more)
...
Cohesion: 0.04
Nodes (46): ApiClient, authHeaders(), AuthProviders, authProvidersSchema, CreateSessionInput, jsonHeaders(), RequestOptions, responseErrorSchema (+38 more)
...
Cohesion: 0.09
Nodes (18): createAttachmentStorage(), normalizePublicBaseUrl(), R2_ENVIRONMENT_KEYS, ATTACHMENT_STORAGE, AttachmentObject, AttachmentStoragePort, PutAttachmentObjectInput, BinaryResponse (+10 more)

### Community 19 - "support.js"
Cohesion: 0.10
Nodes (16): get(), compileTemplate(), createExternalModules(), createHelmetManager(), createPseudoSheet(), createRegistry(), createRuntime(), dcNameFromPath() (+8 more)

### Community 20 - "json-parsers.ts"
Cohesion: 0.08
Nodes (15): Inject, Inject, cloneSnapshot(), ConnectedAgentsRegistry, Injectable, authenticateDeveloper(), authenticatePm(), prisma (+7 more)
...
Cohesion: 0.22
Nodes (9): findTopLevelEquality(), parensWrapWhole(), resolve(), resolvePath(), waitFor(), waitFor(), waitForReadiness(), waitForReadiness() (+1 more)
...
Cohesion: 0.11
Nodes (14): UploadedScreenshot, CreateSessionAttachmentsInput, AttachmentsRepositoryAdapter, Inject, Injectable, mapAttachment(), parseAttachmentPurpose(), parseAttachmentVisibility() (+6 more)
...
Cohesion: 0.12
Nodes (12): mapReviewRequest(), ReviewRequestsRepositoryAdapter, Inject, Injectable, PersistenceRepositories, CreateReviewRequestInput, ReviewRequestsRepository, UpdateReviewRequestStatusInput (+4 more)
...
Cohesion: 0.20
Nodes (6): AppModule, Module, bootstrap(), startApplication(), prisma, startApplication()
...
Cohesion: 0.06
Nodes (31): ButtonProps, ButtonVariant, variantClasses, ConnectionActivityRail(), ConnectionActivityRailProps, RailMetricProps, AgentProjectOption, DeveloperProjectForm() (+23 more)
...
Cohesion: 0.13
Nodes (9): isCommandAcknowledgement(), repositoriesMatch(), resolveDeveloperReadinessFailure(), AgentCommandEnvelope, RecordingAgentCommandRouter, port, server, createAgentServer() (+1 more)
...
Cohesion: 0.14
Nodes (17): ConversationScreenshot(), ConversationThread(), ConversationThreadProps, asRecord(), buildSessionConversation(), extractErrorMessage(), humanizeAgentError(), mergeAdjacentAgentOutput() (+9 more)

### Community 89 - "agent-command-routing.integration.test.ts"
Cohesion: 0.09
Nodes (20): Inject, Injectable, ValidationRunsRepositoryAdapter, CreateValidationRunInput, ValidationRunsRepository, allowedProgressTransitions, interruptedOperationStatuses, interruptedPreparationStatuses (+12 more)
...
Cohesion: 0.07
Nodes (46): AgentExecutionCapabilitiesService, SessionExecutionSelection, Injectable, AgentProjectBindingService, Injectable, ConnectedAgentSnapshot, RequireSessionAccess(), mapProjectReadinessSnapshot() (+38 more)
...
Cohesion: 0.14
Nodes (12): AGENT_AUTHENTICATION_OPTIONS, AgentAuthenticationOptions, AgentAuthenticationService, AgentCredentialInput, AuthenticatedAgentPrincipal, extractBearerToken(), isRecord(), parseCredentials() (+4 more)
...
Cohesion: 0.16
Nodes (9): appendScreenshotsToReviewDescription(), buildConventionalCommitMessage(), buildGitPushBranchCommand(), buildSessionBranchName(), CreateDraftReviewRequestUseCase, DraftReviewRequestResult, escapeMarkdownLabel(), Injectable (+1 more)
...
Cohesion: 0.11
Nodes (21): ExternalIdentitiesRepositoryAdapter, Inject, Injectable, isToolReadinessKey(), isToolReadinessStatus(), parseJsonObject(), parseToolReadinessCheck(), parseToolReadinessChecks() (+13 more)
...
Cohesion: 0.12
Nodes (11): Body, HttpCode, Inject, Post, AuthResult, AuthService, Inject, Injectable (+3 more)

### Community 166 - "ReadyPreviewTunnelPort"
Cohesion: 0.06
Nodes (37): Inject, isProjectMembershipRole(), mapProjectMembership(), mapSessionMember(), mapValidationRun(), parseProjectMembershipRole(), ProjectMembersRepositoryAdapter, Inject (+29 more)
...
- **Why does `resolve()` connect `github-developer-identity.adapter.ts` to `json-parsers.ts`, `persistence.integration.test.ts`, `support.js`, `AgentCommandEnvelope`, `example-project.integration.test.ts`, `walk`, `createRuntime`?**
...
- **Why does `SandboxRef` connect `create-draft-review-request.use-case.ts` to `review-requests.repository.ts`, `ReviewRequestsRepository`, `index.ts`, `command-handling.integration.test.ts`, `mvp-flow.e2e.test.ts`, `createRuntime`?**
