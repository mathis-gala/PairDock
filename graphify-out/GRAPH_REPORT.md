...
Cohesion: 0.06
Nodes (26): Inject, AgentGateway, isCommandAcknowledgement(), isLifecycleProgressStatus(), toSessionAgentEvent(), Inject, Injectable, WebSocketGateway (+18 more)
...
Cohesion: 0.08
Nodes (26): AgentEventsRepositoryAdapter, Inject, Injectable, parseJsonObject(), isExternalIdentityProvider(), isProjectMembershipRole(), mapAgentEvent(), mapProjectMembership() (+18 more)
...
Cohesion: 0.11
Nodes (17): isToolReadinessKey(), isToolReadinessStatus(), parseToolReadinessCheck(), parseToolReadinessChecks(), serializeChecks(), serializeJsonValue(), serializeToolReadinessCheck(), toInputJsonObject() (+9 more)
...
Cohesion: 0.10
Nodes (37): AgentExecutionCapabilitiesService, SessionExecutionSelection, Injectable, AGENT_EVENTS_REPOSITORY, AGENT_REGISTRATIONS_REPOSITORY, ATTACHMENTS_REPOSITORY, EXTERNAL_IDENTITIES_REPOSITORY, MESSAGES_REPOSITORY (+29 more)
...
Cohesion: 0.19
Nodes (5): AuthService, Injectable, Inject, Injectable, UsersService
