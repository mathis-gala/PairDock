# Graph Report - 628f99e4-9b6e-46bd-a055-3d53e7ed7e76  (2026-07-27)
...
## Summary
- 3050 nodes · 6755 edges · 184 communities (156 shown, 28 thin omitted)
...
Cohesion: 0.07
Nodes (19): HealthcheckWaitInput, HealthcheckResult, ProjectPreviewConfig, SandboxPort, SandboxRef, SandboxStartInput, PreviewRuntimeRouter, PreviewRuntimeRouterDependencies (+11 more)
...
Cohesion: 0.12
Nodes (28): BackendEventRejectedError, buildValidationRepairPrompt(), hasRepairableCheckFailure(), isRetryableError(), AgentEventEnvelopeInput, buildAgentConnectedEvent(), buildAgentDoneEvent(), buildAgentOutputEvent() (+20 more)
...
Cohesion: 0.16
Nodes (20): AgentGatewayModule, Module, AuthModule, Module, GithubWebhooksModule, Module, PersistenceModule, Module (+12 more)
...
Cohesion: 0.06
Nodes (27): SessionExecutionSelection, AgentGateway, isCommandAcknowledgement(), isLifecycleProgressStatus(), toSessionAgentEvent(), Inject, Injectable, WebSocketGateway (+19 more)
...
Cohesion: 0.12
Nodes (15): Inject, mapProjectMembership(), mapSessionMember(), ProjectMembersRepositoryAdapter, Injectable, SessionMembersRepositoryAdapter, Injectable, AddProjectMemberInput (+7 more)

### Community 39 - "ToolReadinessService"
Cohesion: 0.07
Nodes (14): Inject, Inject, Inject, Inject, Inject, Inject, Inject, Inject (+6 more)

### Community 40 - "Implementation handoff — PairDock MVP"
Cohesion: 0.11
Nodes (15): Inject, AttachmentsRepositoryAdapter, Injectable, isExternalIdentityProvider(), isProjectMembershipRole(), mapAttachment(), parseAttachmentPurpose(), parseAttachmentVisibility() (+7 more)

### Community 41 - "docker-sandbox.adapter.ts"
Cohesion: 0.11
Nodes (22): ProjectChecksConfig, AgentModelConfig, AgentProjectDescriptor, SaveAgentConfigInput, CommandResult, containerImageSchema, enrichConfigWithProjectManifests(), healthcheckUrlTemplateSchema (+14 more)
...
### Community 43 - "ui.ts"
Cohesion: 0.21
Nodes (6): errorMessage(), SessionRunner, previewUsesDockerTunnel(), GitPushBranchCommandEnvelope, SessionCloseCommandEnvelope, SessionPrepareCommandEnvelope
...
Cohesion: 0.13
Nodes (13): authenticatePm(), prisma, authenticatePm(), prisma, startApplication(), authenticatePm(), prisma, authResponseSchema (+5 more)
...
Cohesion: 0.07
Nodes (26): mapReviewRequest(), mapValidationRun(), ReviewRequestsRepositoryAdapter, Injectable, createPersistenceRepositories(), PersistenceUnitOfWorkAdapter, Injectable, Injectable (+18 more)
...
Cohesion: 0.21
Nodes (5): Inject, buildSessionPrepareCommand(), formatUserDisplayName(), SessionsService, Injectable
...
Cohesion: 0.09
Nodes (17): AgentProjectBindingService, repositoriesMatch(), Inject, Injectable, mapProject(), ProjectsRepositoryAdapter, Injectable, CreateProjectInput (+9 more)
...
### Community 87 - ".create"
Cohesion: 0.10
Nodes (20): Button(), DeveloperProjectCard(), DeveloperProjectCardProps, ProjectFactProps, buildProjectMetadataUpdate(), ProjectMetadataForm(), ProjectMetadataFormProps, ProjectMetadataValues (+12 more)
...
Cohesion: 0.23
Nodes (7): appendScreenshotsToReviewDescription(), buildConventionalCommitMessage(), buildGitPushBranchCommand(), buildSessionBranchName(), CreateReviewRequestUseCase, escapeMarkdownLabel(), Injectable

### Community 90 - "agent-gateway.integration.test.ts"
Cohesion: 0.07
Nodes (25): createDeveloperProjectInputSchema, developerProjectReadinessSchema, developerProjectSessionSummarySchema, developerProjectSetupSchema, developerProjectSummaryListSchema, developerProjectSummarySchema, DeveloperSetupAgent, developerSetupAgentModelSchema (+17 more)

### Community 91 - "AgentCommandEnvelope"
Cohesion: 0.23
Nodes (7): ConversationScreenshot(), ConversationThread(), ConversationThreadProps, SessionConversationItem, sessionQueryKeys, SessionMessageView, LONG_PATH_ITEM
...
Cohesion: 0.06
Nodes (16): HealthcheckService, isInsideSensitiveDirectory(), normalizeRelativePath(), SensitiveFilesPolicy, PreviewCompanionPort, StartAgentRuntimeInput, ImmediateTimeoutHealthcheckService, createTempRepository() (+8 more)
...
Cohesion: 0.08
Nodes (39): AgentCommandRouterService, Inject, Injectable, AttachmentsController, Controller, Inject, SessionAttachmentsService, Injectable (+31 more)
...
Cohesion: 0.20
Nodes (12): ATTACHMENT_STORAGE, detectImageType(), isJpeg(), isPng(), isWebp(), safeOriginalName(), UploadedScreenshot, ValidatedScreenshot (+4 more)
...
Cohesion: 0.18
Nodes (10): AgentExecutionCapabilitiesService, Inject, Injectable, mapSourceControlConnection(), SourceControlConnectionsRepositoryAdapter, Injectable, CreateSourceControlConnectionInput, SourceControlConnectionsRepository (+2 more)
...
Cohesion: 0.29
Nodes (4): ApiClient, DeveloperProjectFormProps, CreateDeveloperProjectInput, DeveloperProjectSetup
...
Cohesion: 0.08
Nodes (23): mapSession(), SessionsRepositoryAdapter, Injectable, CreateSessionInput, allowedProgressTransitions, interruptedOperationStatuses, interruptedPreparationStatuses, InvalidSessionTransitionError (+15 more)

### Community 166 - "ReadyPreviewTunnelPort"
Cohesion: 0.26
Nodes (8): mapMessage(), MessagesRepositoryAdapter, Injectable, CreateMessageInput, MessagesRepository, SessionMessage, SourceControlProvider, UserKind
...
### Community 185 - "Module"
Cohesion: 0.24
Nodes (8): AttachmentsModule, Module, InvitationsModule, Module, ReviewRequestsModule, Module, SessionsModule, Module
...
- **Why does `resolve()` connect `github-developer-identity.adapter.ts` to `persistence.integration.test.ts`, `support.js`, `AgentHarnessEvent`, `AgentCommandEnvelope`, `agent-client.ts`, `scripts`, `walk`, `createRuntime`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `AGENTS.md`, `GithubSourceControlAdapter`?**
