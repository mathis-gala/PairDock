...
## Summary
- 2451 nodes · 4921 edges · 163 communities (137 shown, 26 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43545a82`
...
2. `parseJsonResponse()` - 43 edges
3. `PairDockIdentity` - 42 edges
4. `DatabaseClient` - 38 edges
5. `AppModule` - 34 edges
6. `ProjectsService` - 32 edges
7. `AgentClient` - 28 edges
8. `DatabaseExecutor` - 28 edges
9. `Technical architecture — PairDock MVP` - 24 edges
10. `SessionRunner` - 24 edges
...
Cohesion: 0.13
Nodes (31): agentConfigFileSchema, agentHarnessConfigSchema, agentModelConfigSchema, agentProjectDescriptorSchema, checksConfigSchema, DEFAULT_CONFIG_PATH, loadAgentConfig(), normalizeAgentConfig() (+23 more)

### Community 1 - "create-draft-review-request.use-case.ts"
Cohesion: 0.11
Nodes (7): SandboxPort, SandboxRef, ReadySandboxPort, ReadySandboxPort, ReadySandboxPort, TimeoutSandboxPort, ReadySandboxPort

### Community 2 - "Button"
Cohesion: 0.06
Nodes (37): Button(), ButtonProps, ButtonVariant, variantClasses, DeveloperProjectCardProps, ProjectFactProps, AgentProjectOption, DeveloperProjectForm() (+29 more)

### Community 3 - "events.ts"
Cohesion: 0.08
Nodes (24): agentCommandEnvelopeSchema, agentConnectedEventEnvelopeSchema, AgentDoneEventEnvelope, agentDoneEventEnvelopeSchema, agentEventEnvelopeSchema, AgentOutputEventEnvelope, agentOutputEventEnvelopeSchema, ChecksFailureSummary (+16 more)
...
Cohesion: 0.12
Nodes (13): mapProject(), ProjectsRepositoryAdapter, Inject, Injectable, CreateProjectInput, DeveloperProjectRecord, ProjectsRepository, SharedProjectRecord (+5 more)

### Community 6 - "developer-home-page.tsx"
Cohesion: 0.13
Nodes (12): ProductShellProps, useAuthenticateDeveloper(), useAuthenticatePm(), normalizeSeed(), AuthenticatedUser, authenticatedUserSchema, authResponseSchema, AuthSession (+4 more)
...
Cohesion: 0.12
Nodes (8): mapUser(), Inject, Injectable, UsersRepositoryAdapter, Inject, Injectable, UsersService, PairDockUser

### Community 11 - "client.ts"
Cohesion: 0.08
Nodes (25): AgentCancelCommandEnvelope, agentCancelCommandEnvelopeSchema, AgentPromptCommandEnvelope, agentPromptCommandEnvelopeSchema, ChecksRunCommandEnvelope, checksRunCommandEnvelopeSchema, GitGetDiffCommandEnvelope, gitGetDiffCommandEnvelopeSchema (+17 more)

### Community 12 - "sessions.service.ts"
Cohesion: 0.11
Nodes (16): AgentCommandRouterService, Inject, Injectable, mapSession(), SessionsRepositoryAdapter, Inject, Injectable, CreateSessionInput (+8 more)

### Community 13 - "session.ts"
Cohesion: 0.07
Nodes (22): ApiClient, authApi, authHeaders(), CreateSessionInput, jsonHeaders(), RequestOptions, responseErrorSchema, DeveloperLoginCard() (+14 more)
...
Cohesion: 0.12
Nodes (11): AgentExecutionCapabilitiesService, Inject, Injectable, cloneSnapshot(), isRecord(), ProjectsService, resolveUnavailableReason(), Injectable (+3 more)
...
Cohesion: 0.47
Nodes (4): ProjectPreviewConfig, SandboxStartInput, PreviewTunnelOpenInput, PreviewTunnelRef
...
Cohesion: 0.07
Nodes (10): CancellableHarnessPort, createTempRepository(), error(), execFileAsync, execGit(), MutatingHarnessPort, ReadyPreviewTunnelPort, ReadySandboxPort (+2 more)
...
Cohesion: 0.18
Nodes (10): ExternalIdentitiesRepositoryAdapter, Inject, Injectable, serializeJsonObject(), isExternalIdentityProvider(), mapExternalIdentity(), parseExternalIdentityProvider(), CreateExternalIdentityInput (+2 more)

### Community 31 - "agent-events.repository.ts"
Cohesion: 0.10
Nodes (6): developer, InMemoryRepositories, InMemoryReviewRequestsRepository, pm, RecordingAgentCommandRouter, RecordingSourceControlPort
...
Cohesion: 0.29
Nodes (6): branchExists(), execFileAsync, execGit(), pathExists(), remoteExists(), WorktreeService
...
Cohesion: 0.10
Nodes (18): CreateValidationRunInput, ValidationRunsRepository, buildConventionalCommitMessage(), buildGitPushBranchCommand(), buildSessionBranchName(), CreateDraftReviewRequestUseCase, DraftReviewRequestResult, Inject (+10 more)
...
Cohesion: 0.08
Nodes (26): allocateHostPort(), appendLogs(), buildDockerRunArgs(), DockerSandboxAdapter, DockerSandboxAdapterDependencies, inferPortsFromHealthcheck(), ManagedSandboxProcess, onceExit() (+18 more)
...
### Community 43 - "ui.ts"
Cohesion: 0.20
Nodes (8): RequireSessionAccess(), SessionAccessGuard, Inject, Injectable, SessionStartSource, CreatePromptBody, CreateSessionBody, createDraftReviewRequestInputSchema
...
Cohesion: 0.13
Nodes (5): createTempRepository(), execFileAsync, execGit(), FailOnceClosePreviewTunnelPort, ReadyPreviewTunnelPort
...
Cohesion: 0.16
Nodes (19): SessionExecutionSelection, ConnectedAgentSnapshot, AGENT_EVENTS_REPOSITORY, AGENT_REGISTRATIONS_REPOSITORY, EXTERNAL_IDENTITIES_REPOSITORY, MESSAGES_REPOSITORY, PERSISTENCE_UNIT_OF_WORK, PROJECT_MEMBERS_REPOSITORY (+11 more)
...
Cohesion: 0.07
Nodes (35): appendLogs(), CheckResult, ChecksResult, ChecksRunner, isTransientPackageExtractionFailure(), RunChecksInput, ChangedFile, CollectedDiff (+27 more)

### Community 53 - "test-json.ts"
Cohesion: 0.09
Nodes (13): ConnectedAgentsRegistry, Injectable, authenticateDeveloper(), authenticatePm(), prisma, startApplication(), developerProjectListResponseSchema, developerProjectResponseSchema (+5 more)
...
Cohesion: 0.25
Nodes (3): SessionsService, Inject, Injectable
...
### Community 60 - "project-manifest.ts"
Cohesion: 0.21
Nodes (13): AgentProjectDescriptor, CommandResult, enrichConfigWithProjectManifests(), loadProjectManifest(), mergeProjects(), normalizeGithubRemote(), normalizeTunnelManifest(), pairdockManifestSchema (+5 more)
...
Cohesion: 0.19
Nodes (6): buildAgentCancelCommand(), buildAgentPromptCommand(), SessionPromptService, Injectable, Inject, AgentCommandEnvelope
...
### Community 67 - "session-state-machine.ts"
Cohesion: 0.20
Nodes (6): allowedProgressTransitions, InvalidSessionTransitionError, NoChangesResumeStatus, ProgressStatus, SessionAgentEvent, SessionStateMachine

### Community 68 - "main.ts"
Cohesion: 0.30
Nodes (10): main(), parseModelMapping(), parseModelMappings(), parseProjectMapping(), parseProjectMappings(), runLogin(), runStart(), runStatus() (+2 more)
...
Cohesion: 0.09
Nodes (9): BlockingPushWorktreeService, createTempRepository(), execFileAsync, execGit(), FailingClosePreviewTunnelPort, FailingHealthcheckService, FakePreviewTunnelPort, FakeSandboxPort (+1 more)
...
Cohesion: 0.10
Nodes (24): isProjectMembershipRole(), mapValidationRun(), parseProjectMembershipRole(), createPersistenceRepositories(), PersistenceUnitOfWorkAdapter, Inject, Injectable, Inject (+16 more)
...
### Community 87 - "session-prompts.integration.test.ts"
Cohesion: 0.17
Nodes (6): authenticateDeveloper(), authenticatePm(), createSession(), prisma, startApplication(), sessionPromptResponseSchema

### Community 88 - "json-parsers.ts"
Cohesion: 0.27
Nodes (10): isToolReadinessKey(), isToolReadinessStatus(), parseToolReadinessCheck(), parseToolReadinessChecks(), serializeChecks(), serializeToolReadinessCheck(), toInputJsonObject(), toInputJsonValue() (+2 more)
...
Cohesion: 0.15
Nodes (11): DiffService, isSessionDiffPayload(), SessionDiffView, AgentEventsRepositoryAdapter, Inject, Injectable, parseJsonObject(), mapAgentEvent() (+3 more)

### Community 95 - "PairDock Interactive Prototype"
Cohesion: 0.13
Nodes (17): createApiClient(), SharedProjectCard(), SharedProjectCardProps, ProductShell(), SessionStarted, StartPmSessionInput, useSharedProjects(), UseSharedProjectsResult (+9 more)

### Community 96 - "auth.integration.test.ts"
Cohesion: 0.20
Nodes (7): AgentEventEnvelope, announceAgent(), authenticateDeveloper(), authenticatePm(), prisma, startApplication(), waitForConnect()
...
Cohesion: 0.19
Nodes (5): Inject, AuthService, readOAuthStartUrlConfig(), Inject, Injectable
...
Cohesion: 0.20
Nodes (8): mapReviewRequest(), ReviewRequestsRepositoryAdapter, Inject, Injectable, PersistenceRepositories, CreateReviewRequestInput, ReviewRequestsRepository, ReviewRequestRecord

### Community 106 - "agent-client.integration.test.ts"
Cohesion: 0.14
Nodes (11): AgentGateway, isCommandAcknowledgement(), isLifecycleProgressStatus(), toSessionAgentEvent(), Inject, Injectable, ConnectedSocket, MessageBody (+3 more)

### Community 107 - "tsconfig.json"
Cohesion: 0.33
Nodes (5): extends, include, src/**/*.ts, ../../tsconfig.base.json, ../../tests/packages/local-agent/**/*.ts

### Community 108 - "sessions.service.ts"
Cohesion: 0.25
Nodes (10): buildSessionPrepareCommand(), compareSessionMembers(), CreateSessionInput, CreateSessionRequest, formatUserDisplayName(), isProgressStatus(), isRecord(), parseSessionAgentEvent() (+2 more)

### Community 109 - ".constructor"
Cohesion: 0.22
Nodes (7): PreviewToolbar(), ReviewRequestDialog(), ReviewRequestDialogProps, useSessionData(), formatSessionStatus(), PmSessionPage(), PmSessionPageProps
...
Cohesion: 0.11
Nodes (14): AgentHarnessEvent, AgentHarnessPort, RunPromptInput, AgentHarnessEventQueue, buildCommandArgs(), CodexHarnessAdapter, isCodexCommand(), isRecord() (+6 more)
...
### Community 129 - "healthcheck.service.ts"
Cohesion: 0.25
Nodes (5): HealthcheckService, HealthcheckTimeoutError, HealthcheckWaitInput, HealthcheckResult, ImmediateTimeoutHealthcheckService
...
Cohesion: 0.47
Nodes (6): ProjectChecksConfig, AgentConfig, SaveAgentConfigInput, ProjectAgentHarnessConfig, ReadinessRunnerConfig, AgentClientConfig
...
Cohesion: 0.14
Nodes (12): InvitationsService, Inject, Injectable, mapSessionMember(), SessionMembersRepositoryAdapter, Inject, Injectable, AddSessionMemberInput (+4 more)
...
### Community 148 - "session-runner.ts"
Cohesion: 0.33
Nodes (4): SessionCloseResult, SessionPrepareHooks, SessionRecoveryResult, SessionRunnerConfig
...
### Community 154 - "ReadyPreviewTunnelPort"
Cohesion: 0.15
Nodes (4): PreviewTunnelPort, ReadyPreviewTunnelPort, ReadyPreviewTunnelPort, ReadyPreviewTunnelPort

## Knowledge Gaps
- **574 isolated node(s):** `ProgressStatus`, `NoChangesResumeStatus`, `allowedProgressTransitions`, `CreateSessionInput`, `CreateSessionRequest` (+569 more)
...
- **Why does `DatabaseClient` connect `codex-harness.adapter.ts` to `prisma.config.ts`, `index.ts`, `mappers.ts`, `mvp-flow.e2e.test.ts`, `github-developer-identity.adapter.ts`, `external-identities.repository.ts`, `DatabaseClient`, `test-json.ts`, `agent-prompt-command.integration.test.ts`, `SessionsService`, `source-control-connections.repository.ts`, `ui-gateway.browser-auth.integration.test.ts`, `shared-projects.integration.test.ts`, `pm-session-start.integration.test.ts`, `auth.service.ts`, `session-prompts.integration.test.ts`, `agent-command-routing.integration.test.ts`, `agent-gateway.integration.test.ts`, `auth.integration.test.ts`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Post` to `source-control-connections.repository.ts`, `healthcheck.service.ts`, `support.js`, `Get`, `RequireAuth`, `CodexHarnessAdapter`, `@nestjs/platform-express`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `AgentClient` connect `AgentClient` to `source-control-connections.repository.ts`, `main.ts`, `developer-project-form.tsx`, `command-handling.integration.test.ts`, `json-parsers.ts`, `agent-command-routing.integration.test.ts`, `mvp-flow.e2e.test.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Are the 15 inferred relationships involving `AppModule` (e.g. with `bootstrap()` and `startApplication()`) actually correct?**
  _`AppModule` has 15 INFERRED edges - model-reasoned connections that need verification._
- **What connects `ProgressStatus`, `NoChangesResumeStatus`, `allowedProgressTransitions` to the rest of the system?**
