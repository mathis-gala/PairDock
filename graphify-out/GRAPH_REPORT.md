...
## Corpus Check
- 299 files · ~135,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2772 nodes · 5932 edges · 170 communities (147 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9befa88`
...
8. `SandboxRef` - 35 edges
9. `SessionRunner` - 34 edges
10. `Project` - 34 edges
...
Cohesion: 0.08
Nodes (14): HealthcheckWaitInput, ProjectPreviewConfig, SandboxPort, SandboxRef, SandboxStartInput, PreviewRuntimeRouter, PreviewRuntimeRouterDependencies, ReadySandboxPort (+6 more)
...
Cohesion: 0.11
Nodes (12): AGENT_AUTHENTICATION_OPTIONS, AgentAuthenticationOptions, AgentCredentialInput, AuthenticatedAgentPrincipal, extractBearerToken(), isRecord(), parseCredentials(), Inject (+4 more)

### Community 4 - "index.ts"
Cohesion: 0.04
Nodes (50): AgentCancelCommandEnvelope, agentCancelCommandEnvelopeSchema, agentCommandEnvelopeSchema, AgentPromptCommandEnvelope, agentPromptCommandEnvelopeSchema, ChecksRunCommandEnvelope, checksRunCommandEnvelopeSchema, GitGetDiffCommandEnvelope (+42 more)

### Community 5 - "index.ts"
Cohesion: 0.15
Nodes (9): HostCheckCommandExecutor, HostCheckCommandExecutorDependencies, HostCheckCommandInput, HostCheckCommandRunner, HostCommandSpawnOptions, SAFE_HOST_COMMAND_ENVIRONMENT_KEYS, appendLogs(), createCommandProcess() (+1 more)
...
Cohesion: 0.07
Nodes (20): ApiClient, authHeaders(), AuthProviders, authProvidersSchema, CreateSessionInput, jsonHeaders(), RequestOptions, responseErrorSchema (+12 more)
...
Cohesion: 0.15
Nodes (9): DeveloperProjectRecord, isRecord(), ProjectsService, resolveUnavailableReason(), Injectable, PairDockIdentity, CreateDeveloperProjectInput, DeveloperProjectSummary (+1 more)
...
Cohesion: 0.09
Nodes (9): PreviewTunnelPort, ReadyPreviewTunnelPort, ReadyPreviewTunnelPort, createTempRepository(), execFileAsync, execGit(), HARNESS_SCRIPT_PATH, ReadyPreviewTunnelPort (+1 more)
...
Cohesion: 0.11
Nodes (33): AgentCommandRouterService, Injectable, AgentExecutionCapabilitiesService, SessionExecutionSelection, Injectable, AGENT_EVENTS_REPOSITORY, AGENT_REGISTRATIONS_REPOSITORY, EXTERNAL_IDENTITIES_REPOSITORY (+25 more)
...
Cohesion: 0.15
Nodes (12): AgentEventsRepositoryAdapter, Inject, Injectable, parseJsonObject(), isExternalIdentityProvider(), isProjectMembershipRole(), mapAgentEvent(), parseExternalIdentityProvider() (+4 more)

### Community 35 - "sessions.controller.ts"
Cohesion: 0.05
Nodes (40): buildPrepareRunArgs(), createDockerDependencyCacheKey(), createMissingMountpoints(), DockerCommandResult, DockerDependencyPrewarmer, DockerDependencyPrewarmerDependencies, DockerDependencyPrewarmerLogger, errorMessage() (+32 more)
...
Cohesion: 0.16
Nodes (22): buildValidationRepairPrompt(), hasRepairableCheckFailure(), isRetryableError(), AgentEventEnvelopeInput, buildAgentConnectedEvent(), buildAgentDoneEvent(), buildAgentOutputEvent(), buildChecksResultEvent() (+14 more)

### Community 40 - "Implementation handoff — PairDock MVP"
Cohesion: 0.09
Nodes (19): buildAgentCancelCommand(), buildAgentPromptCommand(), SessionPromptService, Injectable, SessionsController, Body, Controller, Get (+11 more)
...
Cohesion: 0.14
Nodes (10): buildHostCommandEnvironment(), execFileAsync, HostPreviewRuntimeAdapter, HostPreviewRuntimeDependencies, HostSpawnOptions, isProcessGroupOwned(), ManagedHostPreviewProcess, createRunningProcess() (+2 more)
...
Cohesion: 0.19
Nodes (9): branchExists(), execFileAsync, execGit(), pathExists(), remoteExists(), WorktreeService, SessionCloseCommandEnvelope, SessionPrepareCommandEnvelope (+1 more)

### Community 47 - "diff.service.ts"
Cohesion: 0.09
Nodes (18): DeveloperProjectCard(), DeveloperProjectCardProps, ProjectFactProps, ProjectShareForm(), ProjectShareFormProps, SessionControlCard(), SessionControlCardProps, checkLabels (+10 more)
...
Cohesion: 0.15
Nodes (15): isToolReadinessKey(), isToolReadinessStatus(), parseToolReadinessCheck(), parseToolReadinessChecks(), serializeChecks(), serializeJsonValue(), serializeToolReadinessCheck(), toInputJsonObject() (+7 more)
...
Cohesion: 0.09
Nodes (18): Inject, AgentProjectBindingService, repositoriesMatch(), Injectable, ProjectReadinessRepository, UpsertProjectReadinessInput, ProjectsRepository, SharedProjectRecord (+10 more)
...
Cohesion: 0.10
Nodes (25): PersistenceUnitOfWorkAdapter, Injectable, PersistenceRepositories, PersistenceUnitOfWork, ReviewRequestsRepository, SessionMembersRepository, SourceControlConnectionsRepository, CreateValidationRunInput (+17 more)
...
Cohesion: 0.18
Nodes (12): Button(), PromptComposer(), PromptComposerProps, ReviewRequestDialog(), ReviewRequestDialogProps, useSessionData(), formatSessionStatus(), getPromptBlockedReason() (+4 more)

### Community 89 - "agent-command-routing.integration.test.ts"
Cohesion: 0.07
Nodes (20): AgentAuthenticationService, Injectable, Inject, AgentGateway, isCommandAcknowledgement(), isLifecycleProgressStatus(), toSessionAgentEvent(), Inject (+12 more)
...
Cohesion: 0.22
Nodes (7): InvitationsService, Inject, Injectable, AddProjectMemberInput, ProjectMembersRepository, ProjectMembership, ProjectMembershipRole
...
Cohesion: 0.08
Nodes (14): HealthcheckService, HealthcheckResult, isInsideSensitiveDirectory(), normalizeRelativePath(), SensitiveFilesPolicy, ImmediateTimeoutHealthcheckService, createTempRepository(), execFileAsync (+6 more)
...
Cohesion: 0.09
Nodes (16): SessionsRepository, buildSessionCloseCommand(), SessionCloseService, Inject, Injectable, Optional, Inject, allowedProgressTransitions (+8 more)
...
Cohesion: 0.14
Nodes (5): RecordedHandshake, RecordingRestoreSessionRunner, SessionRunnerWithRecoveredWorkspace, SessionRunnerWithRecoveryFailure, waitFor()
...
Cohesion: 0.25
Nodes (5): SessionCloseResult, SessionPrepareHooks, SessionRecoveryResult, SessionRunnerConfig, previewUsesDockerTunnel()
...
Cohesion: 0.15
Nodes (11): mapValidationRun(), createPersistenceRepositories(), Inject, Inject, Injectable, ValidationRunsRepositoryAdapter, buildAdapter(), currentDirectory (+3 more)
...
Cohesion: 0.32
Nodes (4): mapProjectMembership(), ProjectMembersRepositoryAdapter, Inject, Injectable
...
Cohesion: 0.11
Nodes (12): ChecksResult, buildPrepareCommand(), createAgentServer(), createManagedWorktreeRoot(), createPreparedValidationFeedbackClient(), createTempRepository(), execFileAsync, execGit() (+4 more)
...
Cohesion: 0.11
Nodes (15): mapSession(), SessionsRepositoryAdapter, Inject, Injectable, CreateSessionInput, agentEvents, externalIdentities, prisma (+7 more)

### Community 147 - "Get"
Cohesion: 0.23
Nodes (5): mapProject(), ProjectsRepositoryAdapter, Inject, Injectable, CreateProjectInput
...
Cohesion: 0.28
Nodes (8): ProjectChecksConfig, AgentConfig, AgentModelConfig, AgentProjectDescriptor, SaveAgentConfigInput, ProjectManifestLoadResult, ProjectAgentHarnessConfig, AgentClientConfig
...
## Knowledge Gaps
- **622 isolated node(s):** `SAFE_HOST_COMMAND_ENVIRONMENT_KEYS`, `HostCommandSpawnOptions`, `HostCheckCommandInput`, `DockerCommandResult`, `DockerDependencyPrewarmerDependencies` (+617 more)
...
- **Why does `resolve()` connect `github-developer-identity.adapter.ts` to `resolve`, `support.js`, `example-project.integration.test.ts`, `AgentCommandEnvelope`, `walk`, `createRuntime`, `@nestjs/websockets`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `SessionRunner` connect `developer-project-form.tsx` to `index.ts`, `ToolReadinessService`, `resolve`, `developer-project-form.tsx`, `command-handling.integration.test.ts`, `ProjectPreviewConfig`, `json-parsers.ts`, `AgentCommandEnvelope`, `AgentClient`, `mvp-flow.e2e.test.ts`, `agent-prompt-command.integration.test.ts`, `createRuntime`, `agent-events.repository.ts`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `boot`, `@nestjs/common`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **What connects `SAFE_HOST_COMMAND_ENVIRONMENT_KEYS`, `HostCommandSpawnOptions`, `HostCheckCommandInput` to the rest of the system?**
